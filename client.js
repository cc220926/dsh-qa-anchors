...
/* 收缩态：一列短横条（每条历史对应一根） */
.history-bars { position: absolute; right: 5px; top: 0; bottom: 0; width: 16px; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px; box-sizing: border-box; overflow: hidden; transition: opacity 0.2s ease; }
